  ...
  return (
    <section id="cta" className="py-32 bg-[#0a1628] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        <p className="text-[#009bbf] text-xs font-light tracking-widest uppercase mb-8">Take the First Step</p>
        <h2 className="text-5xl md:text-6xl font-light text-white mb-8 leading-tight tracking-tight">Ready to discuss your transaction?</h2>
        <p className="text-gray-400 text-lg mb-6 max-w-2xl mx-auto leading-relaxed font-light">
          Our Corporate Finance team offers a free initial consultation to evaluate your situation and explore the best options.
        </p>
        <p className="text-[#009bbf] text-sm font-light mb-12">
          * Receive 30 minutes of free consulting
        </p>
